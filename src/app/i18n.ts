...
export const appText = {
  zh: {
    ...
    returns: {
      title: "收益统计",
      scopes: { yesterday: "昨日", month: "本月", year: "本年", all: "累计" },
      ...
      emptyDescription: "录入第一笔持仓后，这里会按昨日、本月、本年和累计展示收益与明细。",
      addHolding: "录入持仓",
  ...
  en: {
    ...
    returns: {
      title: "Returns",
      scopes: { yesterday: "Yesterday", month: "This Month", year: "This Year", all: "All Time" },
      ...
      emptyDescription: "Add your first holding to see yesterday, monthly, yearly, and all-time returns with details.",
