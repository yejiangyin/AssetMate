...
export const appText = {
  zh: {
    ...
    settings: {
      ...
      dividendReinvestDesc: "仅对基金自动权益事件生效；股票分红按现金到账记录",
      calendar: "交易日历",
      calendarUpdate: "更新",
      ...
      importOk: "数据已导入成功",
      importFail: "导入失败",
      importTooLarge: "导入文件过大，请选择 10MB 以内的 JSON 文件",
      reset: "重置本地数据",
      resetDesc: "清空本地持仓、分组和定投计划，保留显示偏好",
      clear: "清除",
      clearTitle: "清除缓存数据",
      clearDesc: "此操作将清除本地持仓、分组和定投计划，并保留主题、语言、币种等显示偏好。",
      cancel: "取消",
      confirmClear: "确认清除",
      clearOk: "本地数据已清除",
  ...
  en: {
    ...
    settings: {
      ...
      dividendReinvestDesc: "Only applies to fund corporate actions; stock dividends are recorded as cash",
      ...
      importTooLarge: "Import file is too large. Choose a JSON file under 10 MB.",
      reset: "Reset Local Data",
      resetDesc: "Clear holdings, groups, and DCA plans while keeping display preferences",
      clear: "Clear",
      clearTitle: "Clear Cached Data",
      clearDesc: "This will clear local holdings, groups, and DCA plans while keeping theme, language, currency, and other display preferences.",
      cancel: "Cancel",
      confirmClear: "Clear",
