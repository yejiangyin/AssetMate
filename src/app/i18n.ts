...
export const appText = {
  zh: {
    ...
    settings: {
      ...
      dividendReinvest: "现金分红自动再投",
      dividendReinvestDesc: "自动权益事件中，现金分红按当前价折算为新增份额",
      calendar: "交易日历",
      calendarUpdate: "更新",
  ...
  en: {
    ...
    settings: {
      ...
      dividendReinvest: "Auto Reinvest Dividends",
      dividendReinvestDesc: "For automatic actions, convert cash dividends into additional quantity at current price",
