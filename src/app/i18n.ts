...
export const appText = {
  zh: {
    ...
    returns: {
      ...
      incomplete: (count: number) => `${count} 天存在快照缺口、估算汇率或历史基线，收益金额按可用数据计算，收益率已自动降级。`,
  ...
  en: {
    ...
    returns: {
      ...
      cumulativeReturn: "Tracked Return",
      ...
      incomplete: (count: number) => `${count} days contain snapshot gaps, estimated FX, or a historical baseline. Amounts use available data and the rate is downgraded automatically.`,
      ...
      periodRate: "Cash-flow Adjusted Return",
    ...
    holdings: {
      ...
      returnRate: "Unrealized %",
      waitingQuote: "Waiting quote",
      cost: "Cost",
      price: "Price",
      latestNav: "Latest NAV",
      noComparablePrice: "No comparable price",
      estimated: "Est.",
      nav: "NAV",
      quote: "Quote",
      dca: "DCA",
