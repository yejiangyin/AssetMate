...
export const WORKFLOW_REGISTRY: Record<ResearchWorkflowId, WorkflowConfig> = {
  ...
  era_alpha: {
    id: "era_alpha",
    category: "industry",
    agentIds: ["era-alpha-researcher"],
    needsSynthesis: false,
    useFullModel: true,
    parallel: false,
    needsTopicInput: true,
    canonicalSkill: "era-alpha",
    titles: { zh: "时代 α 捕手", en: "Era Alpha" },
    descriptions: { zh: "识别高增长环节，核验增长与估值，建立拐点清单", en: "Find growth leaders, verify evidence and track inflection signals" },
    calls: "1",
  },
  industry_funnel: {
    id: "industry_funnel",
